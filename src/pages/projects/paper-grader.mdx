...
tagline: 'An LLM evaluation system: privacy-preserving scoring against a structured rubric, with quality gates'
description: 'A command-line LLM evaluation system that scores reflective-writing submissions against a structured rubric. Privacy-preserving and consistent, with quality gates that catch ungrounded judgments, saving 60-80 hours per semester.'
...
University educators face an unsustainable grading workload. A single assignment requiring detailed feedback takes 30-45 minutes per student. For a cohort of 90 students, that's 45-70 hours of manual marking, usually done over weekends and breaks.
...
**Grading inconsistency stems from fatigue, not incompetence.** Experienced educators grade the same paper differently on Monday versus Friday. The problem isn't a lack of standards. It's cognitive load during marathon grading sessions.
...
**Privacy concerns block AI adoption.** Faculty had strong ethical concerns about sending student work to third-party APIs, even when tools showed promise. This wasn't technophobia. It was a legitimate concern about privacy compliance and student consent.
...
The system doesn't replace educator judgment. It handles the mechanical first pass. Faculty get detailed AI-generated feedback to review, edit, and approve rather than writing from scratch. The work shifts from "generate 90 sets of detailed feedback" to "spot-check and refine 90 drafts."
...
I designed the system to save both graded feedback AND anonymized papers. That lets faculty spot-check AI decisions against original student work, building trust through transparency rather than asking for blind acceptance.
...
**Quality control must be designed into the workflow.** Saving anonymized papers alongside feedback enables spot-checking. Timestamp logging tracks performance, and clear file naming makes manual review fast. None of this was an add-on. It was core to building faculty trust.
