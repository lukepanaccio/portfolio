...
This personal project explored how AI can enable conversational learning at scale. I applied instructional design principles to build an always-available Socratic mentor. I built it independently, but the capabilities map directly to enterprise learning: using AI to give personalized guidance, cut cognitive load through brief interactions, and create emotionally safe learning environments.

**Learning objective:** Prove that AI can teach using the Socratic method (guiding self-discovery through questions) rather than just delivering information. That would validate conversational AI as a viable learning modality for complex, nuanced subject matter.
...
Chose voice over text chat, since natural speech creates authentic philosophical dialogue. Used OpenAI's Realtime API to eliminate the 2-4 second delays common in traditional speech processing.
...
**Problem identified:** Early versions were too agreeable. They validated users instead of challenging their reasoning.
...
- **Presence drives engagement.** Photorealistic avatars create a sense of "being with" Marcus that lifts engagement well above text or voice-only. This validates embodied cognition research.

- **Conversational scaffolding is instructional design.** Forcing Socratic questioning (not direct answers) keeps people thinking actively instead of listening passively. The system prompt works as a teaching strategy.
